...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '699c8cef97a24ce09beac06ffc38cc1c,en:699c8cef97a24ce09beac06ffc38cc1c',
  ...
  GREETING_WORDS:
    ...
    'Hi，欢迎来到元宇宙星球🎉, This，人工智能、元宇宙、 AIGC一站式知识平台🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '元宇宙星球', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '🎉元宇宙星球|人工智能|元宇宙|AIGC一站式知识平台🎉', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.cmu123.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '元宇宙星球,人工智能,元宇宙,AIGC一站式知识平台', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'penergumen@gmail.com', // 邮箱地址 例如mail@tangly1024.com
